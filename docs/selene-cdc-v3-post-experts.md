...
### 15.2bis Responsabilité Juridique de la Plateforme

**Positionnement légal de Séléné :**

Séléné est une **plateforme de mise en relation** (au sens de l'Art. L111-7 du Code de la consommation), non un organisateur d'activités sportives. Ce positionnement doit être clairement établi dans les CGU pour limiter la responsabilité délictuelle ou quasi-délictuelle en cas d'incident lors d'une rencontre sportive organisée via l'application.

**Clauses CGU obligatoires :**
- Séléné n'est pas organisateur des activités sportives publiées sur la plateforme
- Les utilisateurs participent sous leur entière responsabilité
- Séléné ne garantit pas l'identité, la compétence sportive, ni le comportement des utilisateurs
- Les utilisateurs sont responsables du respect du droit commun (code de la route, règles de sécurité sportive)
- Séléné décline toute responsabilité pour les dommages corporels, matériels ou moraux survenus lors d'une rencontre

**Recommandations utilisateurs (intégrées à l'onboarding) :**
- Contracter une assurance personnelle couvrant la pratique sportive (assurance licenciée, assurance individuelle accidents)
- Vérifier que leur mutuelle/assurance habitation couvre les accidents sportifs
- Pour les créateurs d'activités en structure : vérifier leur couverture responsabilité civile

**Couverture Séléné :**
- Assurance Responsabilité Civile Professionnelle souscrite avant le lancement public (budget ~2 000-3 000 €/an)
- Mention explicite dans les CGU que Séléné peut être tenu responsable uniquement en cas de faute avérée dans la modération ou la vérification d'identité
...
M25-M30 : **Consolidation nationale**
          Objectif : 200 000 MAU (break-even), 15+ villes actives
          Focus : rétention, ARPU, modération à l'échelle, runway vers break-even
          Pas de nouvelle ville si J30 < 25% dans les villes actives
          
M30+    : Ambition internationale (Belgique, Suisse FR, Maroc FR) uniquement
          après break-even atteint et Seed round clôturé
```

**Stratégie cold start — Résolution du problème de double marché vide :**

Le risque principal d'une app géolocalisée est de se lancer avec une carte vide. Plan d'exécution concret :

**Phase pré-lancement Lyon (M-3 à M0) :**
- Signer des partenariats avec **15-20 clubs sportifs lyonnais** (cible : FC Lyon, clubs padel/tennis, asso running Presqu'île) — offre : compte Pro gratuit 6 mois en échange de publication hebdomadaire
- Recruter **25 ambassadeurs** (coachs, organisateurs associatifs) avec mission : publier 2 activités/semaine minimum les 3 premiers mois
- Objectif J+1 de lancement : **≥ 30 activités sur la carte** avant ouverture publique (seed content)
- Incentive utilisateurs pionniers (150 premiers) : badge "Pionnier Séléné" permanent + 3 mois Premium offerts

**Stratégie d'activation locale (par ville, M+1 à M+6) :**
1. Partenariat avec 15-20 clubs sportifs locaux (comptes Pro offerts 6 mois, renouvelables si >10 matchs/mois)
2. Événements IRL de lancement ("Tournoi Séléné") — budget 2 000-3 000 € par événement
3. 20-25 ambassadeurs recrutés 4 semaines avant ouverture (pas à J+0)
4. Contenu géolocalisé TikTok/Instagram pour chaque ville — 1 créateur local recruté

**KPI anti-carte-vide :**
- Lancement bloqué si < 20 activités disponibles sur la carte au moment de l'ouverture publique
- Dashboard interne : densité d'activités par geohash pour détecter les zones mortes
...
**Hypothèses Premium :**
- Prix brut : 4,99 €/mois
- Commission stores : 30% (Apple/Google — réduit à 15% après an 1 pour petits développeurs, Small Business Program)
- **ARPU Premium net : ~4,00 €/mois** (après commission 15% an 1+, ~3,49 € an 0)
- Taux conversion Free → Premium : 3% (M6), 5% (M12), 7% (M24)

**Hypothèses Pro :**
- Prix brut : 39 €/mois (vente directe web prioritaire pour éviter commission stores)
- Commission IAP si achat in-app : 20% → ARPU net : 31 €/mois
- ARPU Pro net via web (cible) : 37 €/mois (commission Stripe 1.4% + 0.25€)
- Taux conversion Free → Pro : 0.3% (M6), 0.6% (M12), 1% (M24)

**Hypothèses LTV (Lifetime Value) :**
- Durée de vie moyenne estimée : 18 mois Premium, 24 mois Pro
- LTV Premium : 4 €/mois × 18 mois = **72 €**
- LTV Pro : 34 €/mois × 24 mois = **816 €** (mix IAP/web)
- LTV blended (pondéré Free/Premium/Pro) : **~8 €** par utilisateur inscrit (M12)

**Ratios LTV/CAC :**
- CAC moyen canal mixte : 2,80 € → LTV/CAC blended : **~2,9x** (objectif : >3x à M18)
- CAC Premium converti (CAC/taux conversion 5%) : ~56 € → LTV/CAC Premium : **~1,3x** (M12)
- Objectif LTV/CAC Premium > 3x à M24 via réduction CAC (viral organique) + augmentation durée de vie

> **Note investisseur :** le ratio LTV/CAC Premium de 1,3x à M12 est volontairement conservateur. Il s'améliore avec la croissance du viral organique (CAC → 0) et la stabilisation de la rétention. Le modèle Pro (clubs/coachs) présente des LTV/CAC > 14x, compensant la faible volume.
