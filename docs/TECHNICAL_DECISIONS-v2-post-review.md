...
**Statut :** v2 — Post-review Architect-Tech-1 + Architect-Tech-2 + Expert-Security
...
| Background location strategy | When In Use / ForegroundService | Sprint 1 |
| Navigation Flutter | GoRouter (recommandé) vs AutoRoute | Sprint 1 |
